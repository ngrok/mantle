...
- To trim the production stylesheet, add `mantleSourcesPlugin()` from
  ...
  The CSS file does not change. Dev scans every mantle file; the build
  lists only the mantle files the client bundle contains.
