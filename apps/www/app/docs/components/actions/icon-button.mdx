...
<Example className="flex flex-wrap gap-6">
	...
	<div>
		...
		<div className="flex items-center gap-2">
			<IconButton appearance="ghost" label="prestige worldwide" size="lg" icon={<GlobeIcon />} />
			<IconButton appearance="outlined" label="prestige worldwide" size="lg" icon={<GlobeIcon />} />
		</div>
	</div>
	<div>
		<p className="mb-2 text-center font-mono text-xs">Size xl</p>
		<div className="flex items-center gap-2">
			<IconButton appearance="ghost" label="prestige worldwide" size="xl" icon={<GlobeIcon />} />
			<IconButton appearance="outlined" label="prestige worldwide" size="xl" icon={<GlobeIcon />} />
		</div>
	</div>
	<div>
