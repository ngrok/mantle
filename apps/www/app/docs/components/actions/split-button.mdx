---
title: Split Button
description: A button group that pairs a one-click default action with a dropdown menu of related alternatives.
---
...
A button group that pairs a one-click default action with a dropdown menu of related alternatives. Best for when users typically want one action but occasionally need variants.
...
A button group that pairs a one-click default action with a dropdown menu of related alternatives.
