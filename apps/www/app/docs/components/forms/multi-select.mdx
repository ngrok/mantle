...
A typeahead multi-select combobox that allows users to select multiple values with filtering. Selected values are displayed as removable tags. Built on top of [ariakit Combobox](https://ariakit.org/components/forms/combobox) with full keyboard support and [WAI-ARIA Combobox Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/combobox/) compliance.
...
The `MultiSelect` components are built on top of [ariakit Combobox](https://ariakit.org/components/forms/combobox).
