...
The `Switch` is built on top of [Radix Switch](https://www.radix-ui.com/primitives/docs/components/forms/switch). It exposes the same API with the following additional props:
