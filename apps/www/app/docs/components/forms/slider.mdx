...
The `Slider` is built on top of [Radix Slider](https://www.radix-ui.com/primitives/docs/components/forms/slider). It accepts all props from the Radix Slider Root component.
