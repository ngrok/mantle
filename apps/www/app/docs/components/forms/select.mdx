...
The `Select` components are built on top of [Radix Select](https://www.radix-ui.com/primitives/docs/components/forms/select).
...
All props from Radix [Select.Root](https://www.radix-ui.com/primitives/docs/components/forms/select#root), plus:
...
All props from Radix [Select.Trigger](https://www.radix-ui.com/primitives/docs/components/forms/select#trigger), plus:
...
Radix [Select.Value](https://www.radix-ui.com/primitives/docs/components/forms/select#value) props.
...
All props from Radix [Select.Content](https://www.radix-ui.com/primitives/docs/components/forms/select#content), plus:
...
Radix [Select.Group](https://www.radix-ui.com/primitives/docs/components/forms/select#group) props.
...
Radix [Select.Item](https://www.radix-ui.com/primitives/docs/components/forms/select#item) props.
...
Radix [Select.Label](https://www.radix-ui.com/primitives/docs/components/forms/select#label) props.
