...
| `intent?`       | `"accent" \| "danger" \| "neutral"` | `"neutral"`                  | The tone of the underlying [`IconButton`](/components/actions/icon-button). Optional here — the expand toggle's design is neutral-toned, so the wrapper defaults it.          |
