...
A `<td>` for rendering individual data cells. Provides mantle typography, padding, and alignment. Re-exported from [`Table.Cell`](/components/data-display/table#tablecell).
