...
- For multi-line or syntax-highlighted blocks. Use [`CodeBlock`](/components/data-display/code-block) instead.
- For keyboard shortcuts. Use [`Kbd`](/components/data-display/kbd).
