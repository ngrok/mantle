	...
	<div className="w-full max-w-lg">
		<DescriptionList.Root>
			...
			<DescriptionList.Item>
				...
				<DescriptionList.Value translate="no">aigk_2fKm9x8Hn3QpYT7zKlR0vW5</DescriptionList.Value>
			</DescriptionList.Item>
			<DescriptionList.Item>
...
`DescriptionList.Root`, `DescriptionList.Item`, `DescriptionList.Label`, and `DescriptionList.Value` each accept an `asChild` prop. When `true`, the part renders its single child instead of its default element (`<dl>`, `<div>`, `<dt>`, `<dd>`), forwarding all class names, `data-*` attributes, and the ref onto that child.

<Example>
	<div className="w-full max-w-lg">
		<DescriptionList.Root>
			<DescriptionList.Item>
				<DescriptionList.Label>Docs</DescriptionList.Label>
				<DescriptionList.Value asChild>
					<a href="https://mantle.ngrok.com">mantle.ngrok.com</a>
				</DescriptionList.Value>
			</DescriptionList.Item>
		</DescriptionList.Root>
	</div>
...
Every part stamps a `data-slot`. A `data-slot` passed to `DescriptionList.Root` joins in front of its own value instead of replacing it.

| Data Attribute | Value                      | Description      |
| -------------- | -------------------------- | ---------------- |
| `data-slot`    | `"description-list"`       | The `<dl>`.      |
