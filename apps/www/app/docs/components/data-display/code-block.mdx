...
Code blocks render and apply syntax highlighting to blocks of code. The `mantleCodeBlockPlugins()` Vite plugin highlights the code at build time with [Shiki](https://shiki.style/), so there is zero highlighting cost in the browser.
