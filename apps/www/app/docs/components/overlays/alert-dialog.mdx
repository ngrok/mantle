...
Alternatively, you can pass `aria-label` or `aria-labelledby` to `AlertDialogContent` and exclude this component.
...
Alternatively, you can pass `aria-describedby` to `AlertDialogContent` and exclude this component.
