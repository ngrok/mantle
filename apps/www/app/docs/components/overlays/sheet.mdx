...
The `Sheet` components are built on top of [Radix Dialog](https://www.radix-ui.com/primitives/docs/components/overlays/dialog).
...
All props from Radix [Dialog.Root](https://www.radix-ui.com/primitives/docs/components/overlays/dialog#root).
...
All props from Radix [Dialog.Trigger](https://www.radix-ui.com/primitives/docs/components/overlays/dialog#trigger).
...
Radix [Dialog.Close](https://www.radix-ui.com/primitives/docs/components/overlays/dialog#close) props.
...
All props from Radix [Dialog.Content](https://www.radix-ui.com/primitives/docs/components/overlays/dialog#content), plus:
...
Same props as [Mantle IconButton](/components/actions/icon-button).
...
All props from Radix [Dialog.Title](https://www.radix-ui.com/primitives/docs/components/overlays/dialog#title).
...
All props from Radix [Dialog.Description](https://www.radix-ui.com/primitives/docs/components/overlays/dialog#description).
