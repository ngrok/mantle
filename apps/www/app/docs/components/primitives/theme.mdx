...
export default function Root() {
	...
	return (
		<html {...htmlProps}>
			...
			<body>
				<ThemeProvider forceTheme={FORCED_THEME}>
					<App />
				</ThemeProvider>
			</body>
		</html>
...
Extracts only the theme cookie key-value pair from a full `Cookie` header string. Pass the result to `MantleStyleSheets` and `useInitialHtmlThemeProps` as `ssrCookie` — this avoids exposing other cookies from the request in loader data.
