...
The root container of the tabs component that provides context for all tab components. Based on [Radix Tabs Root](https://www.radix-ui.com/primitives/docs/components/navigation/tabs#root).
...
Contains the triggers that are aligned along the edge of the active content. Based on [Radix Tabs List](https://www.radix-ui.com/primitives/docs/components/navigation/tabs#list).
...
The button that activates its associated content. Based on [Radix Tabs Trigger](https://www.radix-ui.com/primitives/docs/components/navigation/tabs#trigger).
...
Contains the content associated with each trigger. Based on [Radix Tabs Content](https://www.radix-ui.com/primitives/docs/components/navigation/tabs#content).
