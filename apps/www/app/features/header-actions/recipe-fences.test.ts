 ...
 */
const RECIPE = "app/docs/recipes/header-actions-from-routes.mdx";

const FENCED_FILES = [
	"app/features/header-actions/header-actions.tsx",
	"app/features/header-actions/header-actions.test.tsx",
] as const;
...
describe("header actions recipe fences", () => {
