...
- [#1510](https://github.com/ngrok/mantle/pull/1510) [`7bddeee`](https://github.com/ngrok/mantle/commit/7bddeee95a508292b60df41b57ddde5e860132cc) Thanks [@cody-dot-js](https://github.com/cody-dot-js)! - Add `mantleSourcesPlugin`, a Vite plugin that narrows mantle's Tailwind scan to the files the client bundle contains. The docs page is [mantle.ngrok.com/vite-plugins](https://mantle.ngrok.com/vite-plugins).
...
- [#1508](https://github.com/ngrok/mantle/pull/1508) [`fc71cca`](https://github.com/ngrok/mantle/commit/fc71cca330e3aae43efb3773a568a59e3025ef62) Thanks [@cody-dot-js](https://github.com/cody-dot-js)! - Bump runtime dependencies: `magic-string` to 1.4.1 and `oxc-parser` to 0.150.0.
...
- Updated dependencies [[`fc71cca`](https://github.com/ngrok/mantle/commit/fc71cca330e3aae43efb3773a568a59e3025ef62)]:
  - @ngrok/mantle-server-syntax-highlighter@1.1.15
...
- Updated dependencies [[`25ed46c`](https://github.com/ngrok/mantle/commit/25ed46c5c85807967f26df8f3e0cfbed626991df)]:
  - @ngrok/mantle-server-syntax-highlighter@1.1.11
...
- [#1375](https://github.com/ngrok/mantle/pull/1375) [`e57524a`](https://github.com/ngrok/mantle/commit/e57524a47ad7070fc4d522a33442a68bf375ed7b) Thanks [@cody-dot-js](https://github.com/cody-dot-js)! - Map `sidebar` and `alert-center` to the internal chunks their Tailwind classes actually live in, so
