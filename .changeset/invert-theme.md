...
- `Sandbar`'s floating panel is now an `invert-theme` island: the bar, its buttons, its error alert, and any custom composed children all render inverted from the page theme in all four themes — matching the origin design.
