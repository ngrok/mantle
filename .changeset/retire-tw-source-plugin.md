...
Migration: remove `mantleTwSourcePlugin()` from `vite.config.ts`, delete the generated block between the `/* @ngrok/mantle-vite-plugins:source:start */` and `/* @ngrok/mantle-vite-plugins:source:end */` markers in your global CSS, and add `@import "@ngrok/mantle/source-all.css";` next to your `mantle.css` import so Tailwind scans every mantle component.
